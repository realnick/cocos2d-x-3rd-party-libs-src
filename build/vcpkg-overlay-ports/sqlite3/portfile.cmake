...
# We deliberately pin sqlite3 to 3.50.0 (from 2025) instead of the
# vcpkg default 3.53.3. Reason: sqlite 3.53.x removed the compile-time
# SQLITE_OS_WINRT dispatch, so every UWP-hostile Win32 API is emitted
# unconditionally and the runtime aSyscall[] table falls back to
# LoadLibrary/CreateFileW -- which UWP blocks, giving a crash at 0x0
# inside winOpen. 3.50.0 still has the #if SQLITE_OS_WINRT paths that
# put CreateFile2 / LoadPackagedLibrary into aSyscall[] at compile time.
...
# Inject the vcpkg-generated feature/config header into sqlite3.c and
# sqlite3.h so SQLITE_OS_WINRT=1 (set below for UWP) reaches the code
# before any of its #if guards. Doing this via vcpkg_replace_string
# rather than a patch file makes us line-number independent.
